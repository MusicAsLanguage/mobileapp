...
function TermsAndConditionsScreen({ navigation }) {
    return (
        <Screen style={styles.screen}>
            ...
            <AppText style={styles.detailsText}>
            Family members can receive SMS notifications about new posts or messages in MaL. You can cancel at any time. Text "STOP" to unsubscribe. Text "HELP" for instructions on how to use our service. Message frequency varies. Message and data rates may apply. For questions about SMS notifications, email musicaslanguage@sf-ns.org.{'\n'} 
